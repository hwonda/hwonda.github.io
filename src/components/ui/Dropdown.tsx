...
const DropdownList = ({
  ...
  return isOpen ? (
    <div
      ref={contentRef}
      className={`animate-slideDown absolute flex flex-col p-1 z-50 mt-2 min-w-36 rounded-lg bg-background border border-secondary shadow-lg ring-1 ring-black/5 transition duration-200 ease-out ${
