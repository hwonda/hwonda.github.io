  ...
  return (
    <section className="group">
      ...
      <div className='grid lg:grid-cols-3 gap-4'>
        <RelevanceElement title="데이터 분석가" score={analyst.score} description={analyst.description} />
        <RelevanceElement title="데이터 엔지니어" score={engineer.score} description={engineer.description} />
        <RelevanceElement title="데이터 과학자" score={scientist.score} description={scientist.description} />
      </div>
    </section>
  );
};
